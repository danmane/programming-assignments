...
def assignment():
  ...
  tester.test(dont_repeat_yourself_us(1585332), [63413, 0, 1, 2], "DRY: $15,853.32")

  tester.test(dont_repeat_yourself_harry_potter(5), [0,0,5], "DRY: 5 knuts")
  tester.test(dont_repeat_yourself_harry_potter(182), [0, 6, 8], "DRY: 182 knuts")
  tester.test(dont_repeat_yourself_harry_potter(5382), [10, 15, 17], "DRY: 5382 knuts")
  tester.test(dont_repeat_yourself_harry_potter(95333), [193, 6, 10], "DRY: 95333 knuts")
...
class Tester(object):
  ...
  def report(self):
    if self.n_tests == self.n_successes:
      ...
      print("Finished %s of %s tests. Keep going." % (self.n_successes, self.n_tests))
